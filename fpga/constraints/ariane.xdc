...
set_false_path -from [get_clocks px_clk] -through [get_nets  -filter { NAME =~  "*async*" }  -of_objects [get_cells -hierarchical -filter { NAME =~  "*DCFIFOInp_i*" } ]] -to [get_clocks p_bus_clk] -hold
set_false_path -from [get_clocks p_bus_clk] -through [get_nets  -filter { NAME =~  "*async*" }  -of_objects [get_cells -hierarchical -filter { NAME =~  "*DCFIFOInp_i*" } ]] -to [get_clocks px_clk] -hold
...
set_false_path -from [get_clocks p_bus_clk] -through [get_nets  -filter { NAME =~  "*async*" }  -of_objects [get_cells -hierarchical -filter { NAME =~  "*i_cdc_fifo_gray*" } ]] -to [get_clocks sys_clk] -hold
set_false_path -from [get_clocks sys_clk] -through [get_nets  -filter { NAME =~  "*async*" }  -of_objects [get_cells -hierarchical -filter { NAME =~  "*i_cdc_fifo_gray*" } ]] -to [get_clocks p_bus_clk] -hold
